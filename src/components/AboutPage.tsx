          ...
          <div className="flex justify-center items-start">
            <div className="relative w-48 h-48 sm:w-56 sm:h-56 lg:w-64 lg:h-64 group">
              ...
              <div className="relative w-full h-full rounded-full overflow-hidden border-2 border-primary/30 group-hover:border-primary/50 transition-all duration-300 glow-border scanline">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1604046744901-d38344fd6129?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwZXJzb24lMjBvdXRkb29yJTIwcG9ydHJhaXR8ZW58MXx8fHwxNzYxNDczMzA1fDA&ixlib=rb-4.1.0&q=80&w=1080"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
          ...
          <div className="flex justify-center order-1 md:order-2">
            <div className="relative w-56 h-56 sm:w-64 sm:h-64 lg:w-80 lg:h-80 group">
              ...
              <div className="relative w-full h-full bg-gradient-to-br from-accent/10 to-primary/10 rounded-3xl flex items-center justify-center border-2 border-accent/30 group-hover:border-accent/50 transition-all duration-300 backdrop-blur-sm scanline">
                <div className="text-6xl sm:text-7xl lg:text-8xl transform group-hover:scale-110 transition-transform duration-300">
                  🐹
                </div>
