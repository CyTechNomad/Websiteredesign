...
import { Box, Code2, ExternalLink, Zap } from "lucide-react";
...
export function HomePage() {
  ...
  const projects = [
    ...
    },
    {
      title: "RolleR",
      description:
        "A simple, yet powerful, dice roller in your terminal written in Rust.",
      ...
      <div className="flex flex-col lg:flex-row items-center gap-6 sm:gap-8 lg:gap-12 mb-8 sm:mb-12 lg:mb-20">
        <div className="flex-1 text-center lg:text-left space-y-3 sm:space-y-6 w-full">
          <div className="inline-block">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-1.5 sm:gap-2">
              ...
              <span className="text-accent glow-orange text-sm sm:text-base lg:text-lg">
                Software Engineer
              </span>
              <span className="text-muted-foreground text-sm sm:text-base">
                ]
        ...
        <div className="flex-shrink-0">
          <div className="relative w-40 h-40 sm:w-48 sm:h-48 lg:w-64 lg:h-64 group">
            <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-[#00d4ff]/20 to-accent/20 rounded-lg blur-xl group-hover:blur-2xl transition-all duration-300">
            </div>
                    ...
                    <div className="flex items-start gap-2 sm:gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <CardTitle className="flex items-center gap-1.5 sm:gap-2 group-hover:glow-text transition-all duration-300 text-base sm:text-lg">
                          <span className="text-muted-foreground/50 text-xs sm:text-sm">
                            {"["}
                          </span>
