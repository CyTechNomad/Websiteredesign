        ...
        <div className="space-y-6 sm:space-y-8 lg:space-y-10">
          ...
          <div className="relative">
            ...
            <div className="space-y-3 sm:space-y-4 border-l-2 border-primary/20 pl-3 sm:pl-4">
              <div className="relative">
                <div className="absolute -left-[0.4375rem] sm:-left-[0.5rem] top-[0.25rem] sm:top-[0.3125rem] w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-primary glow-border"></div>
              ...
              <div className="relative">
                <div className="absolute -left-[0.4375rem] sm:-left-[0.5rem] top-[0.25rem] sm:top-[0.3125rem] w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-primary/50"></div>
                <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
                  <span className="text-primary terminal-prompt"></span>
          ...
          <div className="relative">
            ...
            <div className="space-y-3 sm:space-y-4 border-l-2 border-[#ffd700]/20 pl-3 sm:pl-4">
              <div className="relative">
                <div className="absolute -left-[0.4375rem] sm:-left-[0.5rem] top-[0.25rem] sm:top-[0.3125rem] w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-[#ffd700] glow-border"></div>
                <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
              ...
              <div className="relative">
                <div className="absolute -left-[0.4375rem] sm:-left-[0.5rem] top-[0.25rem] sm:top-[0.3125rem] w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-[#ffd700]/50"></div>
                <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
                  <span className="text-[#ffd700] terminal-prompt"></span>
